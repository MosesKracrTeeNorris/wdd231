...
// CONSTANTS
// ============================
const lat = 6.44; //6.447681971076354, 
const lon = -10.61; //-10.618350994711353
const API_KEY = 'a50494d897ae65050cd598da99faaf1b';
...
function setFormTimestamp() {
    ...
    if (timestampField) {
        const now = new Date();
        // Use ISO String for precise, standardized date and time submission
...
function displayThankYouData() {
    ...
    // Preserving any initial message in the div
...
// DISCOVERING PAGE FUNCTIONALITY
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initializing Assignment for week04
    setFormTimestamp();     
    displayThankYouData();  
    setupModals();          
